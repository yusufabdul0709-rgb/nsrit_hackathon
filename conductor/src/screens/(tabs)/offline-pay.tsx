...
export default function OfflinePayScreen({ onBack, details }: { onBack?: () => void, details?: any }) {
  ...
  useEffect(() => {
    if (details) {
      const req = generatePaymentRequest(details);
      setRequestObj(req);
    }
  }, [details]);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Offline Secure Pay</Text>
        <View style={{ width: 40 }} />
      </View>
